...
pub(super) const KEYMAP_ACTIONS: &[KeymapActionDescriptor] = &[
    ...
    action("global", "Global", "toggle_task_list", "Expand or collapse the persistent task list."),
    ...
    action("composer", "Composer", "undo", "Undo the most recent draft edit."),
    action("composer", "Composer", "redo", "Redo the most recently undone draft edit."),
...
pub(super) fn binding_slot<'a>(
    ...
    match (context, action) {
        ...
        ("global", "toggle_task_list") => Some(&mut keymap.global.toggle_task_list),
        ...
        ("composer", "undo") => Some(&mut keymap.composer.undo),
        ("composer", "redo") => Some(&mut keymap.composer.redo),
