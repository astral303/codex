...
fn configured_main_surface_alias_is_used(keymap: &TuiKeymap, alias: &str) -> bool {
    configured_main_surface_contains(keymap, |value| binding_alias_matches(value, alias))
}
...
fn configured_context_alias_is_used(context: &impl Serialize, alias: &str) -> bool {
    configured_context_contains(context, |value| binding_alias_matches(value, alias))
}

fn binding_alias_matches(value: &str, alias: &str) -> bool {
